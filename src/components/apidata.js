...
function APIData() {
    ...
    // useEffect is called once before the return function is called
    useEffect(()=>{
    ...
    const displayOffersList=()=>{
        return offersList.map((offer)=>{
            ...
            return(
                ...
                <span style = {{color:"red", fontSize:"22px"}}> @ {offer.discountpercent}%</span></li>
            )
        })
    }

    return ( 
        <div style={{border:"2px, solid, red", borderRadius:"5px", padding:"4px"}}>
